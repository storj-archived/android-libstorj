...
public class File implements Serializable, Comparable<File> {
     ...
     * 
     * <p>
     * Currently the io.storj.libstorj native library does not determine the file's content
    ...
    public String getMimeType() {
        ...
        // prefer the Java util as io.storj.libstorj returns always 'application/octet-stream'
        try {
